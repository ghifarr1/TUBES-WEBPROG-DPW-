...
<body>
    <div class="container">
        <h1 class="text-center mb-4">MyBooking</h1>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm"><i class="fas fa-eye"></i><a href="{{ route('bukti-penyerahan', $item->id) }}" style="text-decoration: none">Bukti Penyerahan</a></button>
                                <button class="btn btn-warning btn-sm"><i class="fas fa-edit"></i><a href="{{ route('bukti-pengembalian', $item->id) }}" style="text-decoration: none">Bukti Pengembalian</a></button>
                                ...
                                <button class="btn btn-success btn-sm"><i class="fas fa-credit-card"></i><a href="{{ route('form-pembayaran', $item->id) }}" style="text-decoration: none">Bayar</a></button>
                            </td>
                        </tr>
                        @endforeach
